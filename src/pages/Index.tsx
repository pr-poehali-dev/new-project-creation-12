...
const NEWS = [
  ...
  },
  {
    ...
    date: 'Август 2026',
    text: 'Добираем учеников в классы 2, 3, 4, 6, 8. familyclassistra открывает набор в первый класс! Мы ищем ребят, которые хотят учиться в тёплой семейной атмосфере, где каждый ребёнок важен. Приходите на пробный день и познакомьтесь с нашей школой.',
    img: PHOTO_4,
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-white border-b border-border">
        <div className="container flex items-center justify-between h-16">
          ...
          <Button onClick={() => scrollTo('contacts')} className="rounded-full text-sm px-4">
            Записаться
          </Button>
        </div>
      </header>
