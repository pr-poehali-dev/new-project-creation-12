      ...
      <header className="fixed top-0 inset-x-0 z-50 bg-white border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <button onClick={() => scrollTo('hero')} className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-semibold whitespace-nowrap inline-block border-b border-[#7AB592] pb-0.5">
              <span style={{color:'#4A7C59'}}>Family</span><span style={{color:'#7AB592'}}>Class</span><span style={{color:'#4A7C59'}}>Istra</span>
            </span>
          </button>
        ...
        <div className="container py-14">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-8">
            <div className="flex items-center gap-2">
              ...
              <span className="font-display text-xl font-semibold whitespace-nowrap inline-block border-b border-[#7AB592] pb-0.5">
                <span style={{color:'#4A7C59'}}>Family</span><span style={{color:'#7AB592'}}>Class</span><span style={{color:'#4A7C59'}}>Istra</span>
              </span>
            </div>
